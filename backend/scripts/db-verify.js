...
const checks = {
  ...
  kendaraan: ['id','nama_barang','merk','tipe','no_bpkb','plate','plat_khusus','jenis','tanggal_perolehan','masa_berlaku_stnk','waktu_pajak','photos','photo_file_paths','created_by','updated_by'],

...
export default function App(){
 return <Routes>
  ...
  <Route path="/kendaraan" element={<ProtectedRoute menuKey="kendaraan"><Kendaraan/></ProtectedRoute>}/><Route path="/ruang-rapat" element={<ProtectedRoute menuKey="ruang-rapat"><RuangRapat/></ProtectedRoute>}/><Route path="/settings" element={<ProtectedRoute><Settings/></ProtectedRoute>}/><Route path="/profile" element={<ProtectedRoute><Profile/></ProtectedRoute>}/><Route path="/akun" element={<ProtectedRoute><Akun/></ProtectedRoute>}/>
